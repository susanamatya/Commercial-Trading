...
public class Company_BigC {
	// COmpany Stats
	DoDepot trade;// A class wich makes all 100 depots 
	Profit_Loss_Info statement;// A class which
	private String productName= Constants.companyNames[2];
	private String firstImportedProductName= Constants.companyNames[0];
	private String SecondImportedProductName= Constants.companyNames[1];
